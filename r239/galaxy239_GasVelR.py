#galaxy 239 Ray's gas velocity code
import pynbody
import numpy as np
...
filename='/mnt/data0/jillian/gguaman/r239/cosmo25p.768sg1bwK1BHe75.007779'
#filename= '/mnt/data0/jillian/gguaman/r239/r239.007779.tipsy'
redshift=0.03
image_width=20
...
#plt.show()
plt.savefig("galaxy239_GasVelR.png")
