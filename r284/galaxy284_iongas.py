#galaxy 284 ionized gas with BH pos
import pynbody
import numpy as np
import pandas as pd
...
sph.image(s.g[GasFilter],qty="vr",vmin=-20,width=30,denoise=True,approximate_fast=False,log=False)
...
#plt.show()
#plt.savefig("galaxy284_iongas.png")
plt.savefig("galaxy284_iongas(side).png")
