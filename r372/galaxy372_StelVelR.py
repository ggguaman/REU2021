#galaxy 372 Ray's stellar velocity code
import pynbody
import numpy as np
...
filename='/mnt/data0/jillian/gguaman/r372/cosmo25p.768sg1bwK1BHe75.007779'
#filename = '/mnt/data0/jillian/gguaman/r372/r372.007779.tipsy'
redshift=0.01
image_width=20
...
#plt.show()
plt.savefig("galaxy372_StelVelR.png")
