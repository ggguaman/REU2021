#galaxy 306 Ray's stellar velocity code
import pynbody
import numpy as np
...
filename='/mnt/data0/jillian/gguaman/r306/cosmo25p.768sg1bwK1BHe75.007779'
#filename = '/mnt/data0/jillian/gguaman/r306/r306.007779.tipsy'
redshift=0.01
image_width=50
...
#plt.show()
plt.savefig("galaxy306_StelVelR.png")
